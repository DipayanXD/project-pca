...
| **11** | **Profile Management** | Profile view and editing interface allowing students and administrators to inspect their account details, change departmental affiliation, update contact information, and modify passwords. |
...
| `department` | `VARCHAR(100)`, Default `'General'` | Academic or administrative department |
...
│   ├── helpers.php                 # Utility library: XSS sanitization (e()), flash messages, status badges
...
│   └── profile.php                 # Student profile viewing and credential management
│
├── admin/
